...
client = OpenAI(
    ...
    base_url="http://localhost:1997/v1"
)
...
const client = new OpenAI({
  ...
  baseURL: "http://localhost:1997/v1"
});
...
**Solicitud:**
```
POST http://localhost:1997/v1/chat/completions
```
...
llm = ChatOpenAI(
    ...
    openai_api_base="http://localhost:1997/v1",
    temperature=0.7
)
...
llm = OpenAI(
    model="cc/claude-sonnet-4-20250514",
    api_key="your-api-key-from-dashboard",
    api_base="http://localhost:1997/v1"
)
...
openai.api_base = "http://localhost:1997/v1"
...
ROUTER_BASE_URL=http://localhost:1997/v1
...
curl http://localhost:1997/health
...
- Verifica que el puerto 1997 no esté bloqueado
...
- Verifica los modelos disponibles: `curl http://localhost:1997/v1/models`
