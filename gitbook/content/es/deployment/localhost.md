...
- **API Endpoint**: `http://localhost:1997/v1`
...
El puerto de API (1997) y el puerto del dashboard (3000) están configurados en la aplicación. Para cambiarlos, necesitarás modificar el código fuente o usar variables de entorno si se soportan.
...
Si el puerto 1997 o 3000 ya está en uso:
