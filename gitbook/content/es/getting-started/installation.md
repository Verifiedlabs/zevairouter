...
**Qué sucede:**
1. El servidor inicia en `http://localhost:1997`
...
```bash
curl http://localhost:1997/v1/models \
...
**Error:**
```
Error: listen EADDRINUSE: address already in use :::1997
```

**Solución 1: Mata el proceso existente**

```bash
# Encuentra proceso usando el puerto 1997
lsof -i :1997
