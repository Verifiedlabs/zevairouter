...
export const FREE_PROVIDERS = {
  ...
  codebuddy: { id: "codebuddy", alias: "cb", name: "CodeBuddy", icon: "smart_toy", color: "#006EFF", deprecated: true, deprecationNotice: RISK_NOTICE, website: "https://www.codebuddy.ai", notice: { signupUrl: "https://www.codebuddy.ai/login" } },
  "codebuddy-cn": { id: "codebuddy-cn", alias: "cb-cn", name: "CodeBuddy CN", icon: "smart_toy", color: "#1E40AF", deprecated: true, deprecationNotice: RISK_NOTICE, website: "https://www.codebuddy.cn", notice: { signupUrl: "https://copilot.tencent.com", apiKeyUrl: "https://copilot.tencent.com/profile/" }, authModes: ["oauth", "apikey"] },
...
export const OAUTH_PROVIDERS = {
  ...
  autoclaw: { id: "autoclaw", alias: "acl", name: "AutoClaw", icon: "bolt", color: "#7C3AED", textIcon: "AC", website: "https://autoclaw.z.ai", notice: { signupUrl: "https://autoclaw.z.ai" } },
